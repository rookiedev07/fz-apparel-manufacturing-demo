      ...
      <div className="editorial-container">
        ...
        <div className="editorial-content">
          ...
          <p className="editorial-text">
            At Clothique, we believe that true luxury lies in simplicity. Each piece is meticulously crafted to embody timeless elegance and uncompromising quality. Our philosophy is rooted in mindful design, where every stitch tells a story of refinement.
          </p>
          <p className="editorial-text">
